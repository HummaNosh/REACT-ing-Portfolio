        ...
        <div class="thumbnail">
          ...
          <article  class="info">
            ...
            <li class="text about" >I am an Junior Software developer with a proven track record in Sales and Marketing. 
             ...
             <li class="text about"> My biggest strength and also what I am most known for is,  to be an innovative problem solver and passionate about ‘cracking code’ whilst developing apps which are focused around mobile designs and development.  With every project I work on, my intention is to always ensure my audience are engaged for an impactful user experience.
            I love working in a collaborative environment, I have worked on a team of 5-6 members whom each work together in order to create quality projects. I am very excited to leverage my skills as part of a fast-paced, quality-driven team to build better experiences on the web.</li> 
